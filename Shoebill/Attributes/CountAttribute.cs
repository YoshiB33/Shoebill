...
public class CountAttribute(char item, int maximumCount)
    : ValidationAttribute(() => "The field {0} must be a string with a maximum item count of {1}.")
{
    ...
    public override bool IsValid(object? value)
    {
        ...
        var count = ((string)value).Count(c => c == Item);
    ...
    public override string FormatErrorMessage(string name)
    {
        ...
        var useErrorMessageWithMinimum = MinimumCount != 0 && ErrorMessage != null && ErrorMessage != string.Empty;
    ...
    {
        if (MaximumCount < 0) throw new InvalidOperationException("The maximum count is less than 0");
